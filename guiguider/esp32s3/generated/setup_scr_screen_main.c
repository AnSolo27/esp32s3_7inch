...
void setup_scr_screen_main(lv_ui *ui)
{
	...
	lv_table_set_cell_value(ui->screen_main_table_1,0,1,"Price");
	...
	lv_label_set_text(ui->screen_main_btn_1_label, "Clear");
	...
	lv_obj_set_pos(ui->screen_main_btn_1, 567, 215);
	lv_obj_set_size(ui->screen_main_btn_1, 100, 50);
	...
	lv_obj_set_style_bg_color(ui->screen_main_btn_1, lv_color_hex(0xff0027), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_width(ui->screen_main_btn_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_radius(ui->screen_main_btn_1, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_main_btn_1, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
